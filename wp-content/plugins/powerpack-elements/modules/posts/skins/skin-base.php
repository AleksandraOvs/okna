...
abstract class Skin_Base extends Elementor_Skin_Base {
			...
			<div class="pp-search-form">
				...
				<button class="pp-search-form-submit" type="submit" title="<?php esc_attr_e( 'Search', 'powerpack' ); ?>" aria-label="<?php esc_attr_e( 'Search', 'powerpack' ); ?>">
					<?php if ( 'icon' === $button_type ) : ?>
						<i <?php $this->parent->print_render_attribute_string( 'icon' ); ?> aria-hidden="true"></i>
	...
	public function slider_settings() {
		...
		$margin        = ( ! empty( $settings['margin']['size'] ) ) ? absint( $settings['margin']['size'] ) : 10;
		$margin_tablet = ( ! empty( $settings['margin_tablet']['size'] ) ) ? absint( $settings['margin_tablet']['size'] ) : 10;
		$margin_mobile = ( ! empty( $settings['margin_mobile']['size'] ) ) ? absint( $settings['margin_mobile']['size'] ) : 10;
