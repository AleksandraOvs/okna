<?php
if ($offer = carbon_get_theme_option('crb_windows_offer_bg')) {
...
?>
    ...
    background-position: center; background-attachment: fixed;">
        <div class="container">
            <h2 class="title"><?php echo $offer_head = carbon_get_theme_option('crb_windows_offer') ?></h2>
            <?php 
                if ($offer_text = carbon_get_theme_option('crb_windows_offer_text')){
                    ?>
