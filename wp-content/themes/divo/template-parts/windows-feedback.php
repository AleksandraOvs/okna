<?php
if ($fb_list = carbon_get_theme_option('crb_windows_feedback_list')) {
?>
    <section class="section-feedback">
        <div class="container">
            <div class="section-title">
                <h2 class="title">
                    <?php echo carbon_get_theme_option('crb_windows_feedback_head') ?>
                </h2>
            </div>
            <div class="swiper feedback-slider">
                <ul class="swiper-wrapper">
                    ...
                    foreach ($fb_list as $fb_item) {
                        $fb_item_img = $fb_item['crb_windows_feedback_img'];
                    ...
                    ?>
                        <li class="swiper-slide feedback-list__item">
                            ...
                            <h4> <?php echo $fb_item['crb_windows_feedback_name'] ?> </h4>
                            <div><?php echo $fb_item['crb_windows_feedback_text'] ?></div>
                        </li>
                    <?php
                    }
                    ?>
