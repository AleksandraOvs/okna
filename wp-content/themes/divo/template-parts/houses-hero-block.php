<section class="hero-section">
    <?php
    if ($hero_img = carbon_get_theme_option('crb_houses_hero_image')) {
    ...
    if ($hero_head = carbon_get_theme_option('crb_houses_hero_heading')) {

        echo '<h2>' . $hero_head . '</h2>';
    }

    if ($hero_desc = carbon_get_theme_option('crb_houses_hero_description')) {
